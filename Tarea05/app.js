...
function borrarTarea(){
    ...
    let numero = parseInt(prompt("Introduce el numero de la tarea a eliminar"));
    if (numero > 0 && numero <= tareas.length) {
        let tareaEliminar = tareas.splice(numero - 1, 1); 
        alert(`La tarea "${tareaEliminar[0].nombre}" ha sido eliminada.`);
    } else {
